...
namespace UnityEngine.XR.ARFoundation
{
    ...
    public class ARPlaneDebugVisualizer : MonoBehaviour
    {
        ...
        PlaneClassification m_Classifications;
        ...
        void Awake()
        {
            ...
            if ((m_ARPlane.classification & PlaneClassification.Seat) == PlaneClassification.Seat || 
                (m_ARPlane.classification & PlaneClassification.Table) == PlaneClassification.Table)
            {
